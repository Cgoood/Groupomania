  ...
  <main class="form-signin mx-auto p-2 shadow p-3 mb-5 bg-white rounded">
    <form>
      ...
      <div v-if="!isloginMode" class="form-floating">
        <input type="password" class="form-control rounded" id="confirmPassword" placeholder="Password" v-model="confirmPassword"
          required>
      ...
      <p class="mb-1 mt-2" @click.prevent="signUpMode"> <a href="">{{this.isloginMode? "Vous n'avez pas encore de compte?":"Retour à l'écran de connexion"}}</a></p>
    </form>
  </main>
