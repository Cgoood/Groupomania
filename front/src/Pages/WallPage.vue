  ...
  beforeCreate(){
    ...
    fetch(url, options)
      ...
      .then((res) => {
        ...
        this.userLiked = res.liked
        localStorage.setItem("likedPosts", JSON.stringify(this.userLiked))
      })
...
<template>
  ...
  <div class="container-sm">
    ...
    <CardPost :currentUser="currentUser" :id = "post.id" :email = "post.user.email" :content = "post.content" :url = "post.imageUrl" :comments="post.comments" :likes="post.likes" :userLiked="this.userLiked" :isAdmin="isAdmin"></CardPost>
